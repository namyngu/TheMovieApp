...
public class MovieRepository {
    ...
    // MutableLiveData is an extension of LiveData class that adds the ability to modify or set its data
    ...
    public MutableLiveData<List<Movie>> getMutableLiveData() {
        ...
        // enqueue (asynchronous) - performs network request in the background thread and
